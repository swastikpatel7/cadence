...
export function VolumeStep({ suggestedMiles, last30dAvgMiles }: Props) {
  ...
  const subprompt = last30dAvgMiles
    ...
    >
      <div className="flex flex-col items-center gap-8">
        ...
        <p className="max-w-[58ch] text-center text-[13.5px] leading-[1.55] text-white/55">
          Most beginners thrive at 15&ndash;25 mi/wk. Ramps over 30 mi need more
          recovery work — we'll pace it for you.
        </p>
...
function ValueReadout({ value }: { value: number }) {
  return (
    <div className="flex items-baseline gap-3 text-white">
      ...
      <span className="display text-[28px] text-white/65">mi/wk</span>
    </div>
  );
}
